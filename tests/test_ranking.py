...
def test_render_plan():
    ...
    md = render_plan_md(payload, "notes here", {"cuda-cpp": {"compiled": True, "version": "13.3"}})
    assert "GPU-BOUND" in md and "Linear" in md and "notes here" in md and "cuda-cpp" in md
