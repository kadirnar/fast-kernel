...
Then, in Claude Code from the repository root: `/fk-optimize <this directory>` -- or just say
"optimize the Mimi codec" and the agent runs the endless experiment loop. See RECIPES.md and PLAN.md.
