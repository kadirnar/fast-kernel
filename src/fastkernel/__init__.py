...
endless keep/revert optimization loop across Triton, TileLang, CuTe DSL, CUDA C++,
torch.compile and CUDA graphs -- while every experiment is streamed to a live graph.
